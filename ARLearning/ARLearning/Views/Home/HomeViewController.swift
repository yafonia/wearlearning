...
final class HomeViewController: UIViewController {
    ...
    private func destinationViewController(for item: ARCardItem) -> UIViewController {
        switch item {
        case .baseSimulation:
            BaseSimulationViewController(viewModel: BaseSimulationViewModel())
        case .arWorldMap, .arReferenceImage, .arFaceTrackingConfiguration:
            PlaceholderDetailViewController(title: item.title)
        }
    }
}
